...
/usr/bin/mysqldump -p$pass -u$user -h $location --compress labbench > /data/biocode/database_backups/labbench_db.sql
/bin/gzip -f /data/biocode/database_backups/labbench_db.sql
