...
/usr/bin/mysqldump -p$pass -u$user -h $host geneious > /data/biocode/database_backups/geneious_db.sql
/usr/bin/mysqldump -p$pass -u$user -h $location biocode > /data/biocode/database_backups/biocode_db.sql
