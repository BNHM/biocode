...
*/					["div", {
	...
	__numberFormatter.format = function( value ) {
		...
		//	FORMAT DIGIT #
		// JGD: 2007-05-09
		//		Added check if variable_decimals is undefined not to crop decimals
		// JGD: 2007-05-29	- Fixed NumberFormatter to recognize forced_decimals without variable_decimals
		// JGD: 2007-05-30	- Fixed NumberFormatter to recognize variable_decimals = 0
		// JGD: 2007-06-05  - Fixed NumberFormatter to recognize variable_decimals = 0 && forced_decimals = undefined
		if( this.variable_decimals != undefined && this.variable_decimals != 0 ) {
			...
			// JHM: 2007-05-26 - Modified to check forced_decimals to see if any numbers should be specified
			if (this.forced_decimals == undefined) {
